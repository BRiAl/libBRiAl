...
#ifndef brial_embed_h_
#define brial_embed_h_

// include basic definitions
#include <brial/brial.h>
 ...
 *
 * It also imports brial and stores the main context.
 * @note If the brial python module is not at default location you may set
...
private:
  ...
  void set_python_defaults() {
    ...
    PyRun_SimpleString("from brial.frontend import *");

    m_globals = import("__main__").attr("__dict__");
    boost::python::object start = boost::python::eval("brial_start", m_globals, m_globals);
    start(m_globals);
  }    
