 ...
 * @date 2006-04-24
 *
 * This file defines properties of built-in an brial types.
 *
 * @par Copyright:
...
#ifndef brial_common_common_traits_h_
#define brial_common_common_traits_h_
...
/** @class pbori_traits 
 * @brief This class contains property definitions to be used in brial 
 * classes
 *
 **/
